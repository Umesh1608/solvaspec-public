...
| `wetlab_lambda_max.csv` | Derived λ_max for each of 32 measurements | (same archive) |
| `F13_pairs.csv` | 26,487 solute–solvent pairs with experimental λ_max | Zenodo `10.5281/zenodo.XXXX` |
| `F13_splits.json` | Train/val/test indices for the five-fold solute-stratified split | (same archive) |
